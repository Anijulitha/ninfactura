...
4 0 obj <</Length 1200>> stream
BT /F2 38 Tf 170 790 Td (NINFACTURA) Tj
   /F1 24 Tf 150 750 Td (Factura {factura.numero}) Tj
   /F1 18 Tf 80 700 Td (Cliente: {factura.cliente_nombre}) Tj
   80 670 Td (NIF: {factura.cliente_nif or 'Pendiente'}) Tj
   80 620 Td (Concepto: Servicios Ninfactura) Tj
   80 570 Td (Base imponible: {factura.base_imponible:.2f} EUR) Tj
   80 540 Td (IVA 21%: {factura.iva:.2f} EUR) Tj
   /F2 42 Tf 80 480 Td (TOTAL: {factura.total:.2f} EUR) Tj
   /F1 18 Tf 80 400 Td (Gracias por confiar en Ninfactura! (rocket)(purple_heart)) Tj
   80 360 Td (www.ninfactura.onrender.com) Tj
ET
endstream endobj
5 0 obj <</Type /Font /Subtype /Type1 /BaseFont /Helvetica-Bold>> endobj
6 0 obj <</Type /Font /Subtype /Type1 /BaseFont /Helvetica>> endobj
xref 0 7 0000000000 65535 f 0000000010 00000 n 0000000074 00000 n 0000000125 00000 n 0000000285 00000 n 0000000700 00000 n 0000000900 00000 n 
trailer <</Size 7 /Root 1 0 R>> startxref 1300 %%EOF""".encode('utf-8')
